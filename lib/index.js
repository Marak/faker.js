...
function Faker (opts) {
  ...
  self.airport = bindAll(new Airport(self));

  var StarWars = require('./star_wars');
  self.starWars = bindAll(new StarWars(self));
  ...
  var _definitions = {
    ...
    "airport": ["name", "iataCode", "icaoCode"],
    "starWars": ["character", "droid", "planet", "species", "vehicle", "quote", "wookiee"],
    "title": "",
    "separator": ""
  };
