...
function Faker (opts) {
  ...
  var _definitions = {
    ...
    "address": ["city_prefix", "city_suffix", "street_suffix", "county", "country", "country_code", "country_code_alpha_3", "state", "state_abbr", "street_prefix", "street_address", "street_root", "building_number", "postcode", "postcode_by_state", "direction", "direction_abbr", "time_zone"],
