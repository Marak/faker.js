...
var Vehicle = function (faker) {
  ...
  */
  self.bicycle = function () {
    return faker.random.arrayElement(faker.definitions.vehicle.bicycle);
  };
  ...
  * motorcycle
  *
  * @method faker.vehicle.motorcycle
  */
  self.motorcycle = {
    model: function() {
      return faker.random.arrayElement(faker.definitions.vehicle.motorcycle.model);
    },
    type: function() {
      return faker.random.arrayElement(faker.definitions.vehicle.motorcycle.type);
    },
    manufacturer: function() {
      return faker.random.arrayElement(faker.definitions.vehicle.motorcycle.manufacturer);
    }
  }
  
  self.motorcycle.model.schema = {
    "description": "Generates a random motorcycle model.",
    "sampleResults": "Thunderbolt"
  };
  self.motorcycle.type.schema = {
    "description": "Generates a random motorcycle type.",
    "sampleResults": "Custom"
  };
  self.motorcycle.manufacturer.schema = {
    "description": "Generates a random motorcycle manufacturer.",
    "sampleResults": "Yamaha"
  };
