...
function Random (faker, seed) {
  ...
  /**
   * returns a generic random time.
   *
   * @method faker.random.time
   */
  this.time = function () {
    var randomSec = mersenne.rand(59, 0)
    randomSec = randomSec < 10 ?  "0" + randomSec : randomSec
    var randomMin = mersenne.rand(59, 0)
    randomMin = randomMin < 10 ?  "0" + randomMin : randomMin

    var randomHour = mersenne.rand(23, 0)
    randomHour = randomHour === 0 ? '00' : randomHour

    return randomHour + ":" + randomMin + ":" + randomSec
  }
