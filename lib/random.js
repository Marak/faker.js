...
function Random (faker, seed) {
   ...
   * @param {number} count defaults to 1
   * @param {boolean} use the default 0x prefix or not
   */
  this.hexaDecimal = function hexaDecimal(count, use_0x_prefix) {
    if (typeof count === "undefined") {
      count = 1;
    }
    var wholeString = "";
    if (typeof use_0x_prefix === "undefined" || use_0x_prefix === true) {
      wholeString = "0x";
    }
