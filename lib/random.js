...
function Random (faker, seed) {
  ...
  function randomPrecision(minimum, maximum, options) {
      ...
      var value = random.toFixed(precision);

      return options.string ? value : parseFloat(value)
  }
  /**
  ...
  this.number = function (options) {
    ...
    if (options.decimals > 0) {
      return randomPrecision(options.min, options.max, {precision: options.decimals, string: options.string})
    }
    ...
    return options.string ? randomNumber.toString() : randomNumber;
  }
