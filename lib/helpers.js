...
var Helpers = function (faker) {
  ...
  self.slugify = function (string) {
      string = string || "";
      var chars={'í':'i','é':'e','á':'a','ű':'u','ő':'o','ú':'u','ö':'o','ü':'u','ó':'o',
        'Í':'I','É':'E','Á':'A','Ű':'U','Ő':'O','Ú':'U','Ö':'O','Ü':'U','Ó':'O'};
      for (var key in chars) {
        string = string.replace(new RegExp(key, 'g'),chars[key]);
      }
  ...
  self.createTransaction = function(){
    var isHun = faker.locale == 'hu';
    return {
      "amount" : isHun ? faker.finance.amount(1000, 250000, 0) : faker.finance.amount(),
      "date" : new Date(2012, 1, 2),  //TODO: add a ranged date method
      "business": faker.company.companyName(),
      "name": [faker.finance.accountName(), isHun ? faker.finance.mask(3, false, true) : faker.finance.mask()].join(' '),
      "type" : self.randomize(faker.definitions.finance.transaction_type),
      "account" : faker.finance.account() + (isHun ? '-' + faker.finance.account() + '-00000000' : '')
    };
  };
