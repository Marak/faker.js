...
function Datatype (faker, seed) {
  ...
  /**
     ...
     * @param {number} [options] - maximum value
     * @param {number} [options.min=0] - minimum value
     * @param {number} [options.max=99999] - maximum value
     * @param {number} [options.precision=0.01] - precision
     *
     * @return {number}
     */
  ...
  /**
     * returns a single random floating-point number with a given precision or in range
     *
     * @method faker.datatype.float
     *
     * @param {Object|number} [options]
     * @param {number} [options=0.01] - precision
     * @param {number} [options.min=0] - minimum value
     * @param {number} [options.max=99999] - maximum value
     * @param {number} [options.precision=0.01] - precision
     *
