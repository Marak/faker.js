...
var Finance = function (faker) {
   ...
   * currency
   *
   * @method faker.finance.currency
   */
  self.currency = function () {
      var currencyKey = faker.random.objectElement(faker.definitions.finance.currency, 'key');
      var currency = faker.definitions.finance.currency[currencyKey];
      return {
        name: currencyKey,
        code: currency.code,
  ...
  self.currencyCode = function () {
     ...
     */
    self.currencyName = function (currencyCode) {
        if (currencyCode) {
            var currencyName;
            for(var prop in faker.definitions.finance.currency) {
                if (currencyCode === faker.definitions.finance.currency[prop]['code']) {
                    currencyName = prop;
                    break;
                } 
            }
   ...
   * @param {string} [code] - a currency code
   */
  self.currencySymbol = function (currencyCode) {
      var symbol;

      if (currencyCode) {
        for(var prop in faker.definitions.finance.currency) {
            if (currencyCode === faker.definitions.finance.currency[prop]['code']) {
                symbol = faker.definitions.finance.currency[prop]['symbol'];
                break;
            } 
        }
      } else {
