...
function Address (faker) {
  ...
  this.streetAddress = function (useFullAddress) {
      ...
      var address = "";
      var isReverseAddress = faker.locale == 'hu';
      switch (faker.random.number(2)) {
      case 0:
          if (isReverseAddress) {
              address = faker.address.streetName() + " " + Helpers.replaceSymbolWithNumber("###");
          } else {
      ...
      var separator = faker.locale == 'hu' ? " / " : " ";
      return useFullAddress ? (address + separator + faker.address.secondaryAddress()) : address;
  }
  ...
  this.secondaryAddress = function () {
      return Helpers.replaceSymbolWithNumber(faker.random.arrayElement(faker.definitions.address.secondary_address));
  }
