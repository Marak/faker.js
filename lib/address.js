...
function Address (faker) {
  ...
  this.country = function () {
    return (faker.definitions.address.country && faker.definitions.address.country.length > 0) ?
      faker.random.arrayElement(faker.definitions.address.default_country)
      : faker.random.arrayElement(faker.definitions.address.country);
  }
