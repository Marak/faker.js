...
var Internet = function (faker) {
   ...
   * emoji
   *
   * @method faker.internet.emoji
   */
  self.emoji = function () {
    var emojiCodeBlocks = [
      [0x1F600, 0x1F64F], // U+1F600 ... U+1F64F: Emoticons https://en.wikipedia.org/wiki/Emoticons_(Unicode_block)
    ];
    var range = faker.datatype.number(emojiCodeBlocks.length - 1);
    return String.fromCodePoint(faker.datatype.number({
      "min": emojiCodeBlocks[range][0],
      "max": emojiCodeBlocks[range][1],
    }));
  };
