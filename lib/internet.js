...
var Internet = function (faker) {
  ...
  self.userName = function (firstName, lastName) {
      ...
      case 0:
          result = firstName + faker.random.number(999_999_999);
          break;
      case 1:
          result = firstName + faker.random.arrayElement([".", "_"]) + lastName + faker.random.hexaDecimal(10);
          break;
      case 2:
          result = firstName + faker.random.arrayElement([".", "_"]) + lastName + faker.random.number(999_999_999);
          break;
      }
