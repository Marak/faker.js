...
var Internet = function (faker) {
  ...
  self.userName = function (firstName, lastName) {
      ...
      case 1:
          if (faker.locale == 'hu') {
            result = lastName + faker.random.arrayElement([".", "_"]) + firstName;
          } else {
      ...
      case 2:
          if (faker.locale == 'hu' ) {
            result = lastName + faker.random.arrayElement([".", "_"]) + firstName + faker.random.number(99);
          } else {
  ...
  self.domainWord = function () {
      ...
      var name = faker.name.firstName().replace(/([\\~#&*{}/:<>?|\"'])/ig, '').toLowerCase();
      for (var key in chars) {
        name = name.replace(new RegExp(key, 'g'),chars[key]);
      }
      return name;
  };
