...
exports.userName = function() {
  ...
  {
  case 0:
    return Helpers.randomize(definitions.first_name()) + Helpers.randomNumber(90) + Helpers.randomize(definitions.last_name());
    break;
  case 1:
    return Helpers.randomize(definitions.first_name()) + Helpers.randomize(definitions.last_name()) + Helpers.randomNumber(90);
    break;
  }
};
