...
var Lorem = function (faker) {
  ...
  self.sentence = function (wordCount, range) {
    ...
    var sentences = faker.definitions.lorem.sentences;
    var sentence;
    if (sentences instanceof Object && wordCount in sentences) {
      sentence = faker.random.arrayElement(sentences[wordCount]);
      if (sentence) {
        return sentence;
      }
    }
    sentence = faker.lorem.words(wordCount);
